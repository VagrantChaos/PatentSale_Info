...
<main id="main" style="margin-left: 180px;">
    ...
    <form  action="/Wed/searchData?type=byId" method="post">
        <h1 style="text-align: center">Id查询</h1>
        <table style="MARGIN-RIGHT: auto; MARGIN-LEFT: auto; width: 650px; font-size: 22px;">
            <tr>
                ...
                <td>
                    <input type="submit" style="width:70px;height:30px ; font-size:20px;" value="查询" />
                </td>
            </tr>
        </table>
        <br>
